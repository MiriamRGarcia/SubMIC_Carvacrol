%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% Generate figure for bacterial concentration under Carvacrol therapy
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
clear variables
...
subplot(1,2,1)
for i = 1:n_exp
    plot(t,log10(sol_Bc(i,:)),'-','Color',ccc{i},'Linewidth',1.5)
    hold on
    plot(t_exp,log10(Exp1_CFUs_Bc(i,:)),'o','Color',ccc{i},'MarkerFaceColor',ccc{i})
    plot(t_exp,log10(Exp2_CFUs_Bc(i,:)),'o','Color',ccc{i},'MarkerFaceColor',ccc{i})
end
hold off
box off
xlabel('$t$ (h)','Interpreter','Latex')
ylabel('$\log_{10}$(CFUs/mL)','Interpreter','Latex')
title('\textit{B. Cereus}','Interpreter','Latex')

subplot(1,2,2)
for i = 1:n_exp
    plot(t,log10(sol_Ec(i,:)),'-','Color',ccc{i},'Linewidth',1.5)
    hold on
    plot(t_exp,log10(Exp1_CFUs_Ec(i,:)),'o','Color',ccc{i},'MarkerFaceColor',ccc{i})
    plot(t_exp,log10(Exp2_CFUs_Ec(i,:)),'o','Color',ccc{i},'MarkerFaceColor',ccc{i})
end
hold off
box off
xlabel('$t$ (h)','Interpreter','Latex')
